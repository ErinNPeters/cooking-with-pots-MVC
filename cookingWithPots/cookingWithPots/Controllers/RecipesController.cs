...
namespace cookingWithPots.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public async Task<IActionResult> Edit([Bind("RecipeId,Title,Description,SlowCooker,IngredientsNotParsed,InstructionsNotParsed, ImageFile")] RecipeDto recipeDto)
        {
